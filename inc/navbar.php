...
?>
<nav style="background-color: #a8763e" class="navbar navbar-default">
    <div class="container-fluid">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="./mtt" ><?php echo NOMBRE_NEGOCIO ?></a>
        </div>
        <div id="navbar" class="navbar-collapse collapse">
            <ul class="nav navbar-nav">
                ...
                <li><a href="./reportes-ventas"><i class="fa fa-money"></i>Corte de caja</a></li>
                <li><a href="./devoluciones"><i class="fa fa-angle-double-up"></i>Devoluciones</a></li>
